...
module.exports = {
  premiumOnly: true,
    data: new SlashCommandBuilder()
        .setName("forward")
        .setDescription("Şarkıyı ilerletmek için.")
        .addIntegerOption(option =>
            option.setName("saniye")
                .setDescription("İlerletilecek saniye süresi. (10 = 10s)")
                .setMinValue(0)
                .setRequired(true)
        ),
    async execute(interaction) {
        ...
        try {
            ...
            embed.setColor("Blue").setDescription(`⏩ Şarkıyı \`${seconds}s\` ileri sardım.`);
